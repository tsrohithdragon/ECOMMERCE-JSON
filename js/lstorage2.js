...
async function loadProduct(productListUrl) {
    // fetch('https://my-json-server.typicode.com/swagofindia/products/db').then(response => response.json()).then(json => {
          fetch('./products2.json').then(response => response.json()).then(json => {
            console.log(json);
        productList = json
        productList.products.forEach((product) => {
            ...
            <div class="can-body">
                ...
                <li class="list-group-item" id="can-price">
                    ...
                    <li class="list-group-item" id="can-star">${noOfStar()}${product.rating}/5</li>
                </ul>
            </div>
          </div>`
            ...
            {    
                ...
                function addEntry() {
                        ...
                        var entry = {
                            ...
                            "price": productList.products[i].discount,
                            "discount": productList.products[i].price,
                            "id": productList.products[i].url,
                            "rating":productList.products[i].rating,
                            "url":productList.products[i].url
                        };
                        console.log(entry);
